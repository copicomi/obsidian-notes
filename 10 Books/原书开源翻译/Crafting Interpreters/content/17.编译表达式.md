...
[^11]: ![A solid arrow.](10%20Books/原书开源翻译/Crafting%20Interpreters/content/17.编译表达式/calls.png)箭头连接一个函数与其直接调用的另一个函数，![An open arrow.](points-to.png)箭头连接表格中的指针与解析函数。
