...
![The 'menu.brunch(sunday).beverage = "mimosa"' statement, showing that 'menu.brunch(sunday)' is an expression.](10%20Books/原书开源翻译/Crafting%20Interpreters/content/21.全局变量/setter.png)
